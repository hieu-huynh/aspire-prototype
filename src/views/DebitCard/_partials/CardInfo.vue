<template>
  <div :small="isMobile" class="card-info">
    <div :small="isMobile" class="topbar">
      <p class="text-subtitle2 text-dark text-weight-regular topbar__heading">Available balance</p>

      <div class="currency-symbol text-white">S$</div>

      <p class="balance text-h5 text-weight-bold">3,000</p>

      <div class="top-up">
        <img :src="require('@/assets/icons/top-up.svg')" />

        <p class="text-subtitle2 text-info">Top up</p>
      </div>
    </div>

    <div class="card-graphic bg-primary">
      <div class="visibility-toggler"><img :src="require('@/assets/icons/eye-visible.svg')" /></div>
      ...
      <div class="card-content">
        <h6 class="card-holder text-white text-h6 text-weight-bolder">Mark Henry</h6>
        <div class="card-number">
          <div class="secure-number text-white">
            <span class="dot"></span>
            <span class="dot"></span>
            <span class="dot"></span>
          </div>
          ...
          <p class="text-subtitle2 text-white">2020</p>
        </div>

        <div class="card-bottom-area">
          <div class="card-expiry text-white text-weight-medium">Thru: 12/20</div>
          <div class="card-cvv text-white text-weight-medium">CVV:***</div>
        </div>
      </div>
    ...
    <div class="spending-limit">
      <div class="text-subtitle2 text-weight-regular">Debit card spending limit</div>

      <div class="spending-limit__figures">
        <span class="text-primary">$345</span>

        <span class="text-grey-2">&nbsp;| $5,000</span>
      </div>

      <q-linear-progress size="18px" :value="0.25" color="primary" />
    </div>

    <div class="promotion">
      <h5 class="text-body1 text-primary text-weight-medium">1% cashback on debit card</h5>
      <h6 class="text-subtitle1 text-dark text-weight-light">
        You get 1% cashback on your next 5 debit card payments. Hurry, the offer expires soon!
      </h6>
      <div class="promotion__timeout">
        <q-circular-progress
          show-value
        ...
        >
          <div class="countdown">
            <p class="text-body1 text-dark text-weight-medium">15</p>
            <p class="text-caption text-dark text-weight-thin">days left</p>
          </div>
        </q-circular-progress>
      </div>
    </div>
...
.promotion {
  ...
  border: 1px solid rgba(1, 209, 103, 0.15);
  border-radius: 12px;

  background-color: rgba(1, 209, 103, 0.05);
